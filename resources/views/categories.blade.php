...
@section('content')
    ...
    @foreach($photos[0]->photos as $key => $value)
        ...
        <div class="box box-default">
            <div class="box-body">
                <div class='hovereffect'>
                    <img class='img-responsive' src='/storage/{{ $value->filelocation }}' style="height: 200px">
                    <div class="overlay">
                        <h2>Info</h2>
                ...
                <div class='col-md-12' style="height: 200px;">
                    ...
                    <table>
                        ...
                        <tr><td width='25px'><span class='fa fa-list'></span></td>          <td width='80px'><b>Category</b></td>   <td width='30px' class='text-center'>:</td>     <td>{{ $title }}</td></tr>
